...
export default function Header() {
  ...
  return (
    <>
      ...
      <nav className=" f font-serif" style={{ fontFamily: '"Source Serif 4", sans-serif', color: rgb(112, 112, 112), fontWeight: 'bold', fontSize: 'clamp(0.875rem, 0.9rem + 0.2667vw, 1.125rem)' }}>
