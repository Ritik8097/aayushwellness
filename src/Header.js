...
export default function Header() {
  ...
  return (
    <>
      ...
      <nav className="shadow-md f font-serif" style={{ fontFamily: '"Nunito Sans", sans-serif', color: '#6f6b67b3', fontWeight: 'bold', fontSize: 'clamp(0.875rem, 0.9rem + 0.2667vw, 1.125rem)' }}>
